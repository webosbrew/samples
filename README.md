...
| `web/cbe-webos6` | webOS 6 | **unfinished** - 65UP7560, starfish 6.5.2: the ABI is mapped (61-slot delegate, 92-byte `WebViewBase`) and the sample builds, verifies and starts, but the delegate arrives with mis-decoded arguments and the process dies. See `web/cbe-webos6/README.md` |
